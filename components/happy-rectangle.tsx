...
export const HappyRect = () => {
  ...
  return (
    <motion.section
      ...
      ref={targetRef}
      className="hidden sm:flex mt-[50vh] h-[100vh] items-start justify-start"
    >
      <div className="sticky top-1/2 left-1/2 min-h-[50rem] min-w-[50rem] -translate-x-1/2 -translate-y-1/2 whitespace-nowrap before:absolute before:inset-0 before:scale-[var(--scale)] before:border-[2.5rem] before:border-[#f1c944] rounded-md before:opacity-[var(--opacity-border)]">
        <motion.p
          aria-hidden
          style={{ x: textX, y: "-50%" }}
          className="whitepspace-nowrap font-heading2 min-w-screen bg-gradient-to-tr from-[#E0B379] to-[#e8eaed] bg-clip-text text-transparent  absolute top-1/2 left-[calc(-50vw+20rem)] text-[10rem] text-heading"
        >
          Develop Your Idea.
        </motion.p>
        <motion.p
          aria-hidden
          style={{ x: textX, y: "-50%" }}
          className="whitepspace-nowrap font-heading2 bg-gradient-to-tr from-[#E0B379] to-[#e8eaed] bg-clip-text text-transparent min-w-screen absolute top-1/2 left-[calc(-50vw+20rem)] z-[11] text-[10rem] text-transparent [-webkit-text-stroke:1px_var(--color-heading)]"
        >
          Develop Your Idea.
        </motion.p>
        ...
        <motion.p
          ...
          className="absolute left-1/2 top-[80%] space-y-[-100px] bg-gradient-to-tr from-[#E0B379] to-[#e8eaed] bg-clip-text text-transparent font-heading2 text-center leading-[1] text-dark text-[10rem]"
        >
          PROUD
          <br />
