...
const SOCIAL_MEDIAS: SocialMediaLink[] = [
  { icon: (...props) => <TwitterIcon />, link: "https://x.com/ConseptConnect" },
  { icon: (...props) => <FacebookIcon />, link: "https://www.facebook.com/profile.php?id=61571050567740&mibextid=ZbWKwL" },
  { icon: (...props) => <LinkedinIcon />, link: "https://www.linkedin.com/in/consept-connect-783842343/" },
  { icon: (...props) => <InstagramIcon />, link: "https://www.instagram.com/conseptconnect/profilecard/?igsh=cTNkN3FxdDA4OWNw" },
]
  ...
  return (
    <footer className="bg-gradient-to-tr from-transparent via-transparent/5 to-transparent/10 py-12 text-gray-400 backdrop-blur-lg sm:py-16">
      <div className="container mx-auto grid grid-cols-1 gap-8 px-4 sm:grid-cols-2 sm:px-6 lg:grid-cols-4 lg:px-8">
        <div className="flex flex-col items-start">
          ...
          <p className="text-sm leading-relaxed">
            Consept Connect Inc. is a leading provider of innovative solutions for
      ...
      <div className="container mx-auto mt-8 px-4 text-center sm:px-6 lg:px-8">
        <p className="text-sm">© 2025 Consept Connect Inc. All rights reserved.</p>
      </div>
    </footer>
  )
}
